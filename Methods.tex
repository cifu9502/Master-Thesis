...
The final step is to pop vertex $d_2$ which leaves just a single vertex with energy 
\begin{equation}
...
as  the graph \ref{fig:graphDQD}.c). 
The energy of this vertex is 
\begin{equation}
    \epsilon
\end{equation}
As a result of Gauss-Jordan elimination it turns out that the energy of this vertex is the inverse of the green function $G_{d_1d^\dagger_1}$. The final result is then 
...
Energy interval discretization. \label{Energy-interval-discretization} \protect\Source{ By the Author  } }
\end{figure}
