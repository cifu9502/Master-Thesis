...
In the single dot case the DOS 

\begin{figure}[H]
     \centering
    \subfloat[ \label{fig:NRG-1D}]{\includegraphics[scale=0.2]{IMAGES/DQD/NRG-QD.png}}
     \subfloat[Attaching QD2 to the lead \label{fig:NRGDQD-G2}]{\includegraphics[scale=0.42]{IMAGES/DQD/NRG-DQD.png}} 
    \subfloat[Indirect connection of QD2 \label{fig:NRGDQD-tdots}]{\includegraphics[scale=0.4]{IMAGES/DQD/NRG-IndirectDQD.png}}
    
     \caption{\label{fig:NRG-DQD}  \protect\Source{ By the Author  }}
\end{figure}
