...
\begin{figure}[H]
     ...
     \subfloat[ \label{fig:DQD-G2}]{\includegraphics[scale=0.5]{IMAGES/DQD/g1g2-m.png}} \\
    \subfloat[\label{fig:DQD-tdots}]{\includegraphics[scale=0.5]{IMAGES/DQD/tdots-m.png}}\\
    \subfloat[\label{fig:DQD-PHS}]{\includegraphics[scale=0.5]{IMAGES/DQD/phs-m.png}}
