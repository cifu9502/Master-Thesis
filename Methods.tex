...
\begin{enumerate}
    ...
    Suppose we have $\Gamma_2 = \Gamma_1$. The "triangular connections" break Particle Hole Symmetry. The central peak is displaced to the positive part of the spectrum.
...
\begin{figure}[H]
     ...
     \subfloat[ \label{fig:DQD-G2}]{\includegraphics[scale=0.6]{IMAGES/DQD/g1g2-m.png}} \\
    \subfloat[\label{fig:DQD-tdots}]{\includegraphics[scale=0.6]{IMAGES/DQD/tdots-m.png}}\\
    \subfloat[\label{fig:DQD-PHS}]{\includegraphics[scale=0.6]{IMAGES/DQD/phs-m.png}}
...
To compute  dynamical quantities \cite{} like the density of states  is the DMNRG \cite{}. 
