...
\begin{figure}[H]
     ...
     \subfloat[ \label{fig:DQD-G2}]{\includegraphics[scale=0.9]{IMAGES/DQD/g1g2-m.png}} \\
    \subfloat[\label{fig:DQD-tdots}]{\includegraphics[scale=0.65]{IMAGES/DQD/tdots-m.png}}\\
    \subfloat[\label{fig:DQD-PHS}]{\includegraphics[scale=0.8]{IMAGES/DQD/phs-m.png}}
     \caption{ \protect\Source{ By the Author  }}
\end{figure}
