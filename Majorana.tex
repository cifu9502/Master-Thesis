...
\begin{figure}[t]
     \centering
    \subfloat[Figure  \label{fig:M1}]{\includegraphics[scale=0.5]{IMAGES/Majorana/M1.png}}
     \subfloat[Figure \label{fig:M1-e1}]{\includegraphics[scale=0.51]{IMAGES/Majorana/M1-e1.png}} 
    \subfloat[\label{fig:M1-em}]{\includegraphics[scale=0.55]{IMAGES/Majorana/M1-eM.png}}
