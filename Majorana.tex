...
\label{fig:topological}
     \subfloat[$\Gamma_2 = \Gamma_1$ . Inset: Low energy DOS. \label{fig:NRGDQD-G2}]{\includegraphics[scale=0.42]{IMAGES/DQD/NRG-DQD.png}}  \subfloat[\label{fig:NRGDQD-tdots} $t_{dots}=0.689\Gamma$. Low energy DOS. ]{\includegraphics[scale=0.4]{IMAGES/DQD/NRG-IndirectDQD.png}}
\caption{  \protect\Source{\cite{alicea_new_2012}}}
\end{figure}
