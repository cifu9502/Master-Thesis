...
\begin{figure}[bt]
    ...
    \caption{  \label{fig:IndirectCoupling}    Blue bold lines: Spin-$\up$ DOS. Red thin lines: Spin-$\dw$ DOS. The inset at the upper-left corner of each line depicts the configuration. 
    }
    %
    \label{fig:t2>0}
    \end{center}
