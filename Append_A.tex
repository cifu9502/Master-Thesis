...
% %\begin{equation}
% %H = \sum_{i,k} \left(\epsilon+\frac{U}{2}\right)d_{\sigma}^{\dagger}d_{\sigma}+\frac{U_i}{2}(d_{\sigma}^{\dagger}d_{\sigma}-1)^{2} + t_i d_i+d^\dagger_i \gamma_1 + \Gamma_i(d_{\sigma}c_{\sigma})
% %\end{equation}
...
% \vert\downarrow,0,0\rangle\rightarrow
% \end{array}\left[\begin{array}{cccc}
% \epsilon^{+}+\frac{U^{+}}{2}+\epsilon_{m} & 0 & -t_{1} & t_{2}\\
% 0 & \frac{U^{+}}{2}+\epsilon_{m} & t_{2}^{*} & t_{1}^{*}\\
% -t_{1}^{*} & t_{2} & \epsilon_{d_{2}}+\frac{U^{+}}{2}-\epsilon_{m} & t\\
% t_{2}^{*} & t_{1} & t^{*} & \epsilon_{d_{1}}+\frac{U^{+}}{2}-\epsilon_{m}
% \end{array}\right]
% \]
...
% \vert0,\downarrow,\downarrow\rangle\rightarrow
% \end{array}\left[\begin{array}{cccc}
% \frac{U^{+}}{2}-\epsilon_{m} & 0 & t_1 & t_{2}\\
% 0 & \epsilon^{+}+\frac{U^{+}}{2}-2h-\epsilon_{m} & t_{2}^{*} & -t_{1}^{*}\\
% t_1^{*} & t_{2} & \epsilon_{d_{1}}+\frac{U^{+}}{2}-h+\epsilon_{m} & t\\
% t_{2}^{*} & -t_{1} & t^{*} & \epsilon_{d_{2}}+\frac{U^{+}}{2}-h+\epsilon_{m}
% \end{array}\right]
% \]
...
% \vert\uparrow\!\downarrow,\uparrow,0\rangle\rightarrow
% \end{array}\left[\begin{array}{cccc}
% 2\epsilon^{+}+\frac{3U^{+}}{2}+\epsilon_{m} & 0 & t_1 & t_{2}\\
% 0 & \epsilon^{+}+\frac{U^{+}}{2}+2h+\epsilon_{m} & t_{2}^{*} & -t_{1}^{*}\\
% t_1^{*} & t_{2} & f(d_{1},d_{2})+h-\epsilon_{m} & -t\\
% t_{2}^{*} & -t_{1} & -t^{*} & f(d_{2},d_{1})+h-\epsilon_{m}
% \end{array}\right]
% \]
...
% \vert\uparrow,\uparrow\!\downarrow,\downarrow\rangle\rightarrow
% \end{array}\left[\begin{array}{cccc}
% \epsilon^{+}+\frac{U^{+}}{2}+2h-\epsilon_{m} & 0 & -t_1 & t_{2}\\
% 0 & 2\epsilon^{+}+\frac{3U^{+}}{2}-\epsilon_{m} & t_{2}^{*} & t_{1}^{*}\\
% -t_1^{*} & t_{2} & f(d_{2},d_{1})+h+\epsilon_{m} & -t\\
% t_{2}^{*} & t_{1} & -t^{*} & f(d_{1},d_{2})+h+\epsilon_{m}
% \end{array}\right]
% \]
