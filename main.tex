...
\begin{dedication}
\justifying
{\large \textit{"I believe that  beginning research is quiet similar to that magical situation when babies learn how to talk. Initially they are just there, listening conversations. They seem disoriented with the vocabulary, but they are paying attention and they are catching sounds. Soon enough, before you even notice, their own words start to flow."}\\ Memories from my first research meeting with Professors Andr\'es Reyes and A.P. Balachandran. Hear me talk.}

\end{dedication}

\chapter*{Acknowledgments}

This piece summarizes the main aspects of my work during these two lovely years in Brazil. I must acknowledge that coming to this country has been a wonderful and enriching experience. I was gladly surprised by how large is the condensed matter community in the country. I took advantage of this aspect to participate  to participate in several conferences, present my advances, and increase my knowledge on quantum mechanics. In my way, I met up to three Nobel prizes, including Duncan Haldane, whose work inspired me to study topological materials.

 Apart from the academic life, I also learned Portuguese and got the chance to get immersed in depth into the amazing Brazilian culture, I loved their music (specially forr\'o) and meet amazing people.  Today, I look backwards and I get marveled by all the amazing things that happened in these years and those who allowed those things to be possible. 
  Therefore, in this brief statement, I want to thank all the wonderful people that received me here in Brazil:  My thesis advisor Prof. Luis Gregorio, who  suggested to me this project, helped enter into the USP and has guided me ever since with patience and care. I thank my previous advisors, Andres and Cesar, and all my previous professors in Colombia who prepared for this life of research. I thank to my friends and my room partners, all of them have contributed to make this stage of my life an amazing adventure. And finally, but also very important, I would like to thank to my family and to that little cheek. Even from far away I have always felt their support, which endeavored me to pursue for this goal.
