...
\newcommand{\Green}[1]{\mathcal{G}_{#1}(\omega) }
...
supporting edge Majorana zero modes. The interplay of Kondo correlations (between each dot and the leads), exchange interaction (between the dots) and Kondo-Majorana interaction (between the dot and the Majorana modes) will be investigated. The work involves the numerical calculation of the many-body spectrum of the system with Wilson\textquoteright s  Numerical Renormalization Group (NRG) technique.
\begin{description}
\item [{}]~{\small \par}
\end{description}
\end{abstract}
