...
\glsxtrnewsymbol[description={Topological Superconductor}]{TS}{TS}
...
\begin{document}
\includepdf[page={1,2}]{Portada_port.pdf}
\includepdf[page={1,2}]{portada.pdf}
...
\vspace{2em}
\textit{{ \Large To that little cheek}}
\end{dedication}
...
This piece summarizes the main aspects of my work during these two lovely years in Brazil. This has been a wonderful  that will always remain in my mind. While working in this thesis, I not only learned about physics, condensed matter and quantum computing, but I also acquired experience in independent research , which allowed me to improve my coding, writing, oral and drawing skills. This manuscript, our upcoming paper on "Majorana manipulation in double quantum dots" and the thesis presentation performed on May 8,2019, are the final outcomes of this enriching experience. 

Furthermore, I was gladly surprised by the large condensed matter community in Brazil, which allowed me to participate in several conferences, present my advances, and increase my background. In my way, I met up to three Nobel prizes, including Duncan Haldane, whose work inspired me to study topological materials. Apart from the academic life, I also learned Portuguese and got the chance to get immersed in depth into the amazing Brazilian culture, I loved their music (specially forr\'o) and meet amazing people.  Today, I look backwards and I get marveled by all the amazing things that happened in these years and those who allowed everything to be possible. 

  Therefore, in this brief statement, I want to thank all the wonderful people that received me here in Brazil:  My thesis advisor Prof. Luis Gregorio, who  suggested to me this project, helped me enter into the USP and guided me ever since with patience and care. I thank my previous advisors, Andres and Cesar, and all my former professors in Brazil and Colombia who prepared for this life of research. I thank to my friends and my room partners, all of them have contributed to make this stage of my life an amazing adventure. And finally, but also very important, I would like to thank  my family and  that little cheek. Even from far away I have always felt their support, which endeavored me to complete this goal.


 I also acknowledge the financial support by: 1)  Grants No. $307107/2013-2$ and $449148/2014$ $-9$, Conselho Nacional de Desenvolvimento Cient\'ifico e Tecnol\'ogico (CNPq). 2) Grant No. $2016/18495-4$, Funda\c{c}\~ao de Amparo \`a Pesquisa do Estado de S\~ao Paulo (FAPESP). The Institute of Physics (IFUSP). These grants allowed us to develop and present partial and complete results of this project in workshops and conferences. Without this support nothing of this would have ever been possible. Thank you all. 
...
{\large \textit{"I believe that beginning research is quite similar to that magical situation when babies learn how to talk. Initially, they are just there, listening to conversations. They seem disoriented with the vocabulary, but they are paying attention and they are catching sounds. Soon enough, before you even notice, their own words start to flow."}\\  Memories from my first research meeting with Professors Andr\'es Reyes and A.P. Balachandran. Hear me talk.}
...
\vspace*{1cm}
\textbf{Keywords:}  Double quantum dot; Majorana; Manipulation; Kondo; Spectral density.
...
\vspace*{1cm}
\textbf{Palavras chaves:}  Ponto qu\^antico duplo; Majorana; Manipula\c{c}\~ao; Kondo; Densidade espectral.
...
\begin{itemize}
    ...
    \item In-series coupling (\ref{fig:ResultModels} C.III) : An indirect type II Majorana signature is observed in the first dot. This signature is robust, specially in the interacting case, where it is present in all configurations, despite gate voltage tunning. Fano resonances emerge in the second dot. One of these signatures seems to have critical behavior. 
