...
\newcommand{\Source}[1]{\textcolor{red}{\\ {\small \fbox{Source: {\sl#1}}} }}
\begin{document}
\mainmatter
\maketitle
\begin{abstract}
The predicted non-Abelian characteristic of Majorana
quasiparticles has motivated the \textquotedblleft search
